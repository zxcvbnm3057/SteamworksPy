...
typedef void (*QueryUGCRequestCallback_t)(SteamUGCQueryCompleted_t);
...
public:
    ...
    QueryUGCRequestCallback_t _pyQueryUGCRequestCallback;
    ...
    CCallResult<Workshop, SteamUGCQueryCompleted_t> _itemSendQueryUGCRequest;
    ...
    void SetQueryUGCRequestCallback(QueryUGCRequestCallback_t callback)
    {
        _pyQueryUGCRequestCallback = callback;
    }
    ...
    {
        SteamAPICall_t createItemCall = SteamUGC()->SendQueryUGCRequest(handle);
        _itemSendQueryUGCRequest.Set(createItemCall, this, &Workshop::OnQueryUGCRequest);
    }
...
private:
    ...
    void OnQueryUGCRequest(SteamUGCQueryCompleted_t *itemSteamUGCQueryResult, bool bIOFailure)
    {
        if (_pyQueryUGCRequestCallback != nullptr)
        {
            SteamUGCQueryCompleted_t result{
                itemSteamUGCQueryResult->m_handle,
                itemSteamUGCQueryResult->m_eResult,
                itemSteamUGCQueryResult->m_unNumResultsReturned,
                itemSteamUGCQueryResult->m_unTotalMatchingResults,
                itemSteamUGCQueryResult->m_bCachedData,
                *itemSteamUGCQueryResult->m_rgchNextCursor,
            };
            _pyQueryUGCRequestCallback(result);
        }
    }
};
...
SW_PY void Workshop_SetQueryUGCRequestCallback(QueryUGCRequestCallback_t callback)
{
    if (SteamUGC() == NULL)
    {
        return;
    }
    workshop.SetQueryUGCRequestCallback(callback);
}
...
SW_PY bool Workshop_ReleaseQueryUGCRequest(UGCQueryHandle_t handle)
{
    if (SteamUGC() == NULL)
    {
        return false;
...
SW_PY bool Workshop_SendQueryUGCRequest(UGCQueryHandle_t handle)
{
    if (SteamUGC() == NULL)
    {
        return false;
    }
    workshop.SendQueryUGCRequest(handle);
}

SW_PY SteamUGCDetails_t *Workshop_GetQueryUGCResult(UGCQueryHandle_t handle, uint32 index)
{
    SteamUGCDetails_t *pDetails = (SteamUGCDetails_t *)malloc(sizeof(SteamUGCDetails_t));
    ...
    SteamUGC()->GetQueryUGCResult(handle, index, pDetails);
    return pDetails;
}
